...
func TestParseWithOptions(t *testing.T) {
	...
	result, err := Parse("name=John;age=30;city=NYC", &ParseOptions{
		Delimiter: ";",
	})
	if err != nil {
	...
	_, err = Parse(longQuery, &ParseOptions{
		ParameterLimit:       100,
	...
	result2, err := Parse(longQuery, &ParseOptions{
		ParameterLimit:       100,
...
func BenchmarkParseToStruct(b *testing.B) {
	...
	for i := 0; i < b.N; i++ {
		var user User
		_ = ParseToStruct(queryString, &user)
	}
}
...
func TestUnmarshal(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			err := Unmarshal(tt.query, tt.target)
			if (err != nil) != tt.wantErr {
...
func TestMarshalUnmarshalRoundTrip(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Unmarshal back
			err = Unmarshal(queryString, target)
			if err != nil {
...
func BenchmarkUnmarshalComplex(b *testing.B) {
	...
	for i := 0; i < b.N; i++ {
		...
		_ = Unmarshal(queryString, &nested)
	}
}
